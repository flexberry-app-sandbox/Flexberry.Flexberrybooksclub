...
moduleForModel('i-i-s-flexberrybooksclub-meetingrequest', 'Unit | Serializer | i-i-s-flexberrybooksclub-meetingrequest', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-flexberrybooksclub-meetingrequest',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
