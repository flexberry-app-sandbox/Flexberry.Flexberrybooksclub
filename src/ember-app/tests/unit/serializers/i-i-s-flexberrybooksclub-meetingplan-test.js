...
moduleForModel('i-i-s-flexberrybooksclub-meetingplan', 'Unit | Serializer | i-i-s-flexberrybooksclub-meetingplan', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-flexberrybooksclub-meetingplan',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
