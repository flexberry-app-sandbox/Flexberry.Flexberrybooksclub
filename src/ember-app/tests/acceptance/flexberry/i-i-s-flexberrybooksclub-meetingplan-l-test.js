...
moduleForAcceptance('[AGAT] Acceptance | i i s flexberrybooksclub meetingplan l');

test('testing i-i-s-flexberrybooksclub-meetingplan-l', function(assert) {
  visit('/i-i-s-flexberrybooksclub-meetingplan-l');
