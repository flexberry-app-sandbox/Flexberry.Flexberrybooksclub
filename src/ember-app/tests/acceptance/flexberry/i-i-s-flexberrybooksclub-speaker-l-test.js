...
moduleForAcceptance('[AGAT] Acceptance | i i s flexberrybooksclub speaker l');

test('testing i-i-s-flexberrybooksclub-speaker-l', function(assert) {
  visit('/i-i-s-flexberrybooksclub-speaker-l');
