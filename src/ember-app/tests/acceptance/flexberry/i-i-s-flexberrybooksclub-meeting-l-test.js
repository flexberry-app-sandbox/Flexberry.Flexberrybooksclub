...
moduleForAcceptance('[AGAT] Acceptance | i i s flexberrybooksclub meeting l');

test('testing i-i-s-flexberrybooksclub-meeting-l', function(assert) {
  visit('/i-i-s-flexberrybooksclub-meeting-l');
