...
moduleForAcceptance('[AGAT] Acceptance | i i s flexberrybooksclub book l');

test('testing i-i-s-flexberrybooksclub-book-l', function(assert) {
  visit('/i-i-s-flexberrybooksclub-book-l');
